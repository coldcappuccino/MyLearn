...
<html>
	<head>
		...
		<script type="text/javascript">
		    function delProFromCart(pid){
		    	if(confirm("您是否删除该项?")){
		    	    location = "${pageContext.request.contextPath}/delCartItem?pid="+pid;
		    	}
		    }
		    
		    function clearCart(){
		    	if(confirm("您是否要清空购物车?")){
		    	    location = "${pageContext.request.contextPath}/clearCart";
		    	}
		    }
		</script>
	</head>
	...
	<body>
        ...
        <c:if test="${empty cart.cartItems}">
             <div>
                <img style="display:block;margin:auto;" alt="" src="${pageContext.request.contextPath}/images/cart-empty.png">
             </div>
        </c:if>
