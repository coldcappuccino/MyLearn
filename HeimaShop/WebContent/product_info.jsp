				...
				<div class="col-md-6">
					...
					<div
						...
						<div style="margin: 20px 0 10px 0;; text-align: center;">
							<a href="javascript:(0)" onclick="addCart()"> <input
								style="background: url('./images/product.gif') no-repeat scroll 0 -600px rgba(0, 0, 0, 0); height: 36px; width: 127px;"
								value="加入购物车" type="button" id="#quantity">
							</a> &nbsp;收藏商品
						</div>
					</div>
					<div>
					   <a href="${pageContext.request.contextPath}/productListByCid?cid=${cid}&currentPage=${currentPage}">返回列表页</a>
					</div>
				</div>
			</div>
			<div class="clear"></div>
