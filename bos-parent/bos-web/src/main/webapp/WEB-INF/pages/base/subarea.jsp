...
<script type="text/javascript">
	...
	function highcharts(){
		$('#ShowHighChartsSubareaWindow').window("open");
	...
	$(function(){
		...
		// 添加、修改分区
		$('#ShowHighChartsSubareaWindow').window({
	        title: '添加修改分区',
	        width: 600,
	        modal: true,
	        shadow: true,
...
<body class="easyui-layout" style="visibility:hidden;">
    ...
    <!-- highcharts饼状图展示 -->
	<div class="easyui-window" title="区域分区分布图" id="ShowHighChartsSubareaWindow" collapsible="false" minimizable="false" maximizable="false" style="top:20px;left:200px">
