...
<script type="text/javascript">
	...
	function doAssociations(){
		...
		if(rows.length != 1){
			...
			var url_1 = "decidedzoneAction_findLisNotAssociation.action";
			...
			var url_2 = "decidedzoneAction_findLisHasAssociation.action";
			var id = rows[0].id;
	...
	function doDblClickRow(index,date){
		$('#association_subarea').datagrid( {
			fit : true,
			border : true,
			rownumbers : true,
			striped : true,
			url : "subareaAction_findListbyDecidedZoneId.action?decidedzoneId="+date.id,
			columns : [ [{
				field : 'id',
				title : '分拣编号',
				width : 120,
		...
		$('#association_customer').datagrid( {
			...
			rownumbers : true,
			striped : true,
			url : "decidedzoneAction_findLisHasAssociation.action?id="+date.id,
			columns : [[{
				field : 'id',
				title : '客户编号',
				width : 120,
