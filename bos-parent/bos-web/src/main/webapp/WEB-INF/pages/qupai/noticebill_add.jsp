		...
		<form id="noticebillForm" action="noticebillAction_add.action" method="post">
			<table class="table-edit" width="95%" align="center">
				...
				<tr>
					...
					<script type="text/javascript">
					    $(function(){
					    	//页面加载完成后，为手机号输入框绑定一个离焦事件
					    	$("input[name=telephone]").blur(function(){
					    		//发送ajax请求数据
					    		var telephone = this.value;
					    		$.post('noticebillAction_fingCustomerByTelephone.action',{"telephone":telephone},function(data){
					    			 if(data!=null){
					    				 //查询到了客户信息，进行页面回显
				...
				<tr>
					<td>客户姓名:</td>
					<td><input type="text" class="easyui-validatetebox" name="customerName"/></td>
					<td>联系人:</td>
